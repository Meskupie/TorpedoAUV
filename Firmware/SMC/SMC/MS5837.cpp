...
void MS5837::readAsync()
{
    switch(MS5837::_readStep)
    {
        case MS5837_READ_READY:
            MS5837::readA();
            MS5837::_nextStepTime = millis() +20;
            MS5837::_readStep = MS5837_READ_A;
            break;
        case MS5837_READ_A:
            if( millis()>=MS5837::_nextStepTime)
            {
                MS5837::readB();
                MS5837::_nextStepTime = millis() +20;
                MS5837::_readStep = MS5837_READ_B;
            }
            break;
        case MS5837_READ_B:
            if( millis()>=MS5837::_nextStepTime)
            {
                MS5837::readC();
                MS5837::_readStep = MS5837_READ_READY;
            }
            break;
    };
}
